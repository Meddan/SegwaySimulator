...
public class PhysicsEditorShapeLibrary {
    ...
    public Body createBody(String name, IShape pShape, PhysicsWorld pPhysicsWorld) {
		...
		boxBodyDef.type = BodyDef.BodyType.StaticBody;//bodyTemplate.isDynamic ? BodyDef.BodyType.DynamicBody : BodyDef.BodyType.StaticBody;
		...
		final Body polyBody = pPhysicsWorld.createBody(boxBodyDef);
